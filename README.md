...
There are two versions to implement MK-HSIC-Lasso, in the master branch, we modify codes based on HSIC-Lasso, optimising problems based on LARS :[https://github.com/riken-aip/pyHSICLasso].
